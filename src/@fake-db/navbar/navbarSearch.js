...
export const searchArr = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        icon: 'Grid',
        isBookmarked: true,
        target: 'RFMTinventory',
        link: '/apps/vict/RFMTinventory',
