...
// ** Utils
import { hasActiveChild } from '@layouts/utils' //, removeChildren 
...
const VerticalNavMenuGroup = ({
  ...
  return (
    ...
    >
      <Link className='d-flex align-items-center' onClick={e => console.log(e)}>
      ...
      <ul className='menu-content'>
        <Collapse isOpen={true}>
          {/* (groupActive && groupActive.includes(item.id)) || (groupOpen && groupOpen.includes(item.id)) */}
