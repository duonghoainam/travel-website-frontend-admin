...
const ViewDetailModal = ({ open, handleModal }) => {
  ...
  //    const getBookmarks = createAsyncThunk('layout/getBookmarks', async () => {
  ...
  //    const updateBookmarked = createAsyncThunk('layout/updateBookmarked', async id => {
...
//   const [Picker, setPicker] = useState(new Date())
  ...
  return (
    ...
    >
    <ModalHeader className='mb-1' toggle={handleModal} close={CloseBtn} tag='div'>
      <h5 className='modal-title'>View Record</h5>
    </ModalHeader>
    <ModalBody className='flex-grow-1'>
        <Card>
            <CardHeader>
